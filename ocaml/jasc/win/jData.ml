type jpath = (string list* string)[@@deriving show]
...
type jversion = (int* int)[@@deriving show]
...
type unqualified_name = string[@@deriving show]
...
and jmethod_signature = (jsignature list* jsignature option)[@@deriving show]
...
type jsignatures = jsignature list[@@deriving show]
...
type reference_type =
  ...
  | RInvokeSpecial
  | RNewInvokeSpecial
  | RInvokeInterface[@@deriving show]
...
type bootstrap_method = int[@@deriving show]
...
type jaccess = jaccess_flag list[@@deriving show]
...
and jannotation_value =
  ...
  | ValArray of jannotation_value list[@@deriving show]
...
type jattribute =
  ...
  | AttrUnknown of string* string[@@deriving show]
...
type jattributes = jattribute list[@@deriving show]
...
type jfield =
  ...
  jf_code: jcode option;}[@@deriving show]
...
type jfields = jfield list[@@deriving show]
