...
特に他のライブラリを必要とせずに、わずかなコードで完全なGCをC言語で実装し用いる事を可能にしています。
...
mini gcは保守的なGCなので通知する必要はありません<a name="_minigc"></a>\[[3][minigc]\]。
...
C言語へのトランスレータを書く際にも、可読性の高い出力ができるでしょう。
...
- <a name="3"></a><a href="#_minigc">[3]</a> minimum gc
