/*
 * Copyright (c) 2008-2015 h_sakurai, freecluster.net. All rights reserved.
 *
 * ftdop5.scala
 ...
 *
 * HISTORY:
 *  ftdop5.scala append closure, quote, quasiquote, expand, macro, symbol,void
 * TODO:
...
object main {
  ...
  object Macro {
    ...
    def expand(a:Any, e:Env):Any = {
      ...
      case (a,b,c,d) => (expand(a,e),expand(b,e),expand(c,e),expand(d,e))
      case (a,b,c,d,f) => (expand(a,e),expand(b,e),expand(c,e),expand(d,e),expand(f,e))
      case a => a
      }
    }
