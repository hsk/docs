...
let rec (fib:((int))->(int)) = (function | ( 0) -> (0;
)| ( 1) -> (1;
)| ( n) -> ((fib((n - 2)) + fib((n - 1)));
));;
let rec (fib2:((int))->(int)) = (fun ( n) -> (match n with | ( 0) -> (0;
)| ( 1) -> (1;
)| ( n) -> ((fib2((n - 2)) + fib2((n - 1)));
));
);;
...
let (main:(unit)->(unit)) = (fun ( ()) -> printf("add 1 2 = %d\n") (add(1) (2));
printf("addt 1,2 = %d\n") (addt((1 , 2)));
printf("fib 10 = %d\n") (fib(10));
printf("llor %d\n") (llor((1 , 2)));
let a = 12 in
...
let rec (eval:((k))->(int)) = (function | ( KInt(i)) -> (i;
...
printf("%d\n")(f2((1 , 2))((3 , 4)));;
printf("%d\n") (f2((1 , 2)) ((3 , 4)));;
let (f20:((int))->(((int))->(int))) = (fun ( a) ( b) -> (a + b);
);;
let (f21:(int)->(((int))->(int))) = (fun ( a) -> (fun ( b) -> (a + b);
));;
let (f22:(int)->((int)->(int))) = (fun ( a) -> (fun ( b) -> (a + b)));;
let (f23:(int)->((int)->(int))) = (fun ( a) ( b) -> (a + b));;
let (f24:(int)->((int)->(int))) = (fun ( a) ( b) -> (a + b));;
printf("f21 %d\n")(f21(1)(2));;
printf("f22 %d\n")(f22(1)(2));;
printf("f23 %d\n")(f23(1)(2));;
printf("f24 %d\n")(f24(1)(2));;
let f22 = (fun ( a) -> (fun ( b) -> (a + b);
));;
let f23 = (fun ( a) ( b) -> (a + b);
);;
let f24 = (fun ( a) ( b) -> (a + b);
